...
function createtime() { 
    ...
    var e = new Date("09/16/2024 00:00:00"), 
        t = Math.trunc(234e8 + (now - e) / 1e3 * 17), 
        a = (t / 1496e5).toFixed(6), 
        o = new Date("09/16/2024 00:00:00"), 
    ...
    let c = ""; 
        c = s < 22 && s >= 8 ? 
            `<img class='boardsign' src='/badge/正在运行.svg' title='你在看什么~'>
            <br> 
            ...
            `<img class='boardsign' src='/badge/该休息了.svg' title='夜深了~'>
            <br> 
            <div style="font-size:13px;font-weight:bold">本站运行了 ${r} 天 ${s} 小时 ${l} 分 ${b} 秒 
            <i id="heartbeat" class='fas fa-heartbeat'></i> 
            <br> 
